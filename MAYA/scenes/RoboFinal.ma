...
//Name: RoboFinal.ma
//Last modified: Sat, Apr 17, 2021 10:14:45 PM
//Codeset: 932
requires maya "2020";
...
fileInfo "UUID" "D48392C5-45CD-DD41-7DBE-53841643AB98";
createNode transform -s -n "persp";
	rename -uid "79242D8F-4A55-5CFA-69B5-EE80B796F92C";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -6.9225879128953851 3.5889614183612348 27.674330552115084 ;
	setAttr ".r" -type "double3" 3.2616472714915217 357.39999999906922 -1.2436844588003101e-17 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "8AC35E34-4FC4-7258-9426-99AB121E8AE3";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 38.223058597983005;
...
createNode transform -s -n "front";
	...
	setAttr ".t" -type "double3" -5.2240441515987088 5.3434143917339778 1000.1 ;
createNode camera -s -n "frontShape" -p "front";
	rename -uid "B2BF1A36-460E-9253-911F-2E8F327F2069";
	setAttr -k off ".v";
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 23.917731752452482;
...
createNode transform -n "pCylinder5";
	...
	setAttr ".t" -type "double3" -4.729341467036682 6.1305597092282662 -10.669135473041269 ;
...
createNode transform -n "pCylinder6";
	...
	setAttr ".t" -type "double3" -4.8111471554768146 5.6152693322648544 -10.473102033721176 ;
...
createNode transform -n "pSphere2";
	...
	setAttr ".t" -type "double3" -4.9616396047802223 4.0204685962142879 -10.469821755678881 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "69E9D5F6-4F3B-1D6A-34E0-E78C23D83B12";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "04882D98-448D-7E29-2F0F-2F83766A272B";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "B059734C-4A89-0EC5-7433-C7B4FD164A3F";
createNode displayLayerManager -n "layerManager";
	rename -uid "A90B37A4-4531-7A22-D01F-FE9F0AEA8DAC";
	setAttr ".cdl" 2;
...
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "109E82C9-4B98-F4CE-B9C1-9FB8C6CF7296";
...
createNode polyTweak -n "polyTweak30";
	...
	setAttr ".uopa" yes;
	setAttr -s 22 ".tk";
	setAttr ".tk[41]" -type "float3" -0.12005667 -0.021055628 0.042219866 ;
	setAttr ".tk[42]" -type "float3" -0.10065074 -0.021055628 0.080306247 ;
	setAttr ".tk[43]" -type "float3" 0.0098811649 -0.021055628 -9.7077599e-16 ;
	setAttr ".tk[44]" -type "float3" -0.070425086 -0.021055695 0.11053216 ;
	setAttr ".tk[45]" -type "float3" -0.03233818 -0.021055628 0.12993783 ;
	setAttr ".tk[46]" -type "float3" 0.0098811649 -0.021055628 0.13662457 ;
	setAttr ".tk[47]" -type "float3" 0.052100506 -0.021055695 0.12993783 ;
	setAttr ".tk[48]" -type "float3" 0.090187155 -0.021055695 0.11053164 ;
	setAttr ".tk[49]" -type "float3" 0.1204128 -0.021055695 0.080306247 ;
	setAttr ".tk[50]" -type "float3" 0.13981873 -0.021055695 0.042219866 ;
	setAttr ".tk[51]" -type "float3" 0.14650548 -0.021055695 -9.7077599e-16 ;
	setAttr ".tk[52]" -type "float3" 0.13981873 -0.021055695 -0.042219345 ;
	setAttr ".tk[53]" -type "float3" 0.1204128 -0.021055695 -0.080305725 ;
	setAttr ".tk[54]" -type "float3" 0.090187155 -0.021055695 -0.11053111 ;
	setAttr ".tk[55]" -type "float3" 0.052100506 -0.021055695 -0.12993783 ;
	setAttr ".tk[56]" -type "float3" 0.0098811649 -0.021055628 -0.13662457 ;
	setAttr ".tk[57]" -type "float3" -0.03233818 -0.021055628 -0.12993783 ;
	setAttr ".tk[58]" -type "float3" -0.070424564 -0.021055695 -0.11053111 ;
	setAttr ".tk[59]" -type "float3" -0.10065074 -0.021055628 -0.080305725 ;
	setAttr ".tk[60]" -type "float3" -0.12005641 -0.021055628 -0.042219345 ;
	setAttr ".tk[61]" -type "float3" -0.12674367 -0.021055695 -9.7077599e-16 ;
