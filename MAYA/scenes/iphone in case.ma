...
//Last modified: Wed, Mar 24, 2021 12:51:46 PM
//Codeset: 932
requires maya "2020";
...
fileInfo "UUID" "20C1EDA7-4AD7-F168-4558-0B98970D948E";
createNode transform -s -n "persp";
	rename -uid "63542C1F-407C-73CE-99CB-6B84A54455E7";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 37.846635008161257 26.098027411058467 -1.2421658412788865 ;
	setAttr ".r" -type "double3" -33.938352730437153 -629.79999999931601 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "05EFEF59-4C22-92B3-B8AA-6485B1FC7A92";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 42.188473088100885;
...
createNode transform -n "pDisc4";
	...
	setAttr ".t" -type "double3" 0 4.997438952419083 0 ;
...
createNode mesh -n "pDisc4Shape" -p "pDisc4";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.20940456539392471 0.11925670504570007 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 20 ".pt[431:450]" -type "float3"  0 -2.7939677e-09 -9.3132257e-10 
		0 -7.2759576e-12 0 0 0 3.7252903e-09 0 0 3.7252903e-09 0 0 1.4901161e-08 0 -9.3132257e-10 
		-1.4901161e-08 0 -5.8207661e-11 2.9802322e-08 0 9.3132257e-10 -1.4901161e-08 0 0 
		-2.2351742e-08 0 2.7939677e-09 0 0 -9.3132257e-10 -1.4901161e-08 0 2.910383e-11 -2.9802322e-08 
		0 -1.8626451e-09 1.4901161e-08 0 1.8626451e-09 -7.4505806e-09 0 1.8626451e-09 3.7252903e-09 
		0 -1.8626451e-09 -3.7252903e-09 0 -1.4551915e-11 -9.3132257e-10 0 9.3132257e-10 1.8626451e-09 
		0 -9.3132257e-10 -3.7252903e-09 0 1.8626451e-09 -2.2351742e-08;
createNode transform -n "pCube2";
	rename -uid "CBC639FF-4E4B-B4FE-ED37-479783D86779";
	setAttr ".t" -type "double3" -0.17779574977187051 6.1671567361028536 0.19339073407560559 ;
...
createNode mesh -n "pCubeShape2" -p "pCube2";
	...
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 18 ".pt";
	setAttr ".pt[42]" -type "float3" -0.019820834 0.49306116 0 ;
	setAttr ".pt[43]" -type "float3" -0.019820834 0.49306116 0 ;
	setAttr ".pt[44]" -type "float3" -0.038644753 -0.595056 0 ;
	setAttr ".pt[45]" -type "float3" -0.038644753 -0.595056 0 ;
	setAttr ".pt[46]" -type "float3" -6.7205838e-06 -0.10599317 0 ;
	setAttr ".pt[47]" -type "float3" 0.012121446 0.12712625 0 ;
	setAttr ".pt[48]" -type "float3" 0.012121446 0.12712626 0 ;
	setAttr ".pt[49]" -type "float3" -6.7196233e-06 -0.10599311 0 ;
	setAttr ".pt[50]" -type "float3" -0.0087379552 -0.30974892 0 ;
	setAttr ".pt[51]" -type "float3" 0.0087379543 0.30974889 0 ;
	setAttr ".pt[52]" -type "float3" 0.0087379543 0.30974889 0 ;
	setAttr ".pt[53]" -type "float3" -0.0087379552 -0.30974892 0 ;
	setAttr ".pt[54]" -type "float3" -0.016441222 -0.31828144 0 ;
	setAttr ".pt[55]" -type "float3" 0.00095613871 0.29126737 0 ;
	setAttr ".pt[56]" -type "float3" 0.00095613871 0.29126737 0 ;
	setAttr ".pt[57]" -type "float3" -0.016441222 -0.31828144 0 ;
createNode lightLinker -s -n "lightLinker1";
	rename -uid "FE5D9D30-4EC2-8F03-4991-419DED8C023E";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "3FBA47AC-4701-D58E-F9AF-6EBDF40154D8";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "F8E387BC-418E-7C08-20FE-D2827F0FB558";
createNode displayLayerManager -n "layerManager";
	rename -uid "101D6F5A-4DB2-7D1C-C677-78BC055E04CE";
createNode displayLayer -n "defaultLayer";
	rename -uid "D78C4FC1-40B4-08DB-27EE-01920A598FFF";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "5EC905A8-4C73-E4A8-9240-4BA1686F1848";
...
connectAttr "deleteComponent26.og" "pDisc4Shape.i";
