...
//Last modified: Tue, Mar 23, 2021 05:32:57 PM
//Codeset: 932
requires maya "2020";
...
fileInfo "UUID" "F1B7691E-45AD-ED38-0CC0-2B948BFC0C68";
createNode transform -s -n "persp";
	rename -uid "63542C1F-407C-73CE-99CB-6B84A54455E7";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -1.302655320390617 53.132347190766367 4.1384351028452038 ;
	setAttr ".r" -type "double3" -81.338352729016066 6.5999999999965304 -4.0022169818864048e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "05EFEF59-4C22-92B3-B8AA-6485B1FC7A92";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 51.239757088326876;
...
createNode mesh -n "pDisc4Shape" -p "pDisc4";
	...
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 21 ".pt";
	setAttr ".pt[431]" -type "float3" 0 -2.7939677e-09 -9.3132257e-10 ;
	setAttr ".pt[432]" -type "float3" 0 -7.2759576e-12 0 ;
	setAttr ".pt[433]" -type "float3" 0 0 3.7252903e-09 ;
	setAttr ".pt[434]" -type "float3" 0 0 3.7252903e-09 ;
	setAttr ".pt[435]" -type "float3" 0 0 1.4901161e-08 ;
	setAttr ".pt[436]" -type "float3" 0 -9.3132257e-10 -1.4901161e-08 ;
	setAttr ".pt[437]" -type "float3" 0 -5.8207661e-11 2.9802322e-08 ;
	setAttr ".pt[438]" -type "float3" 0 9.3132257e-10 -1.4901161e-08 ;
	setAttr ".pt[439]" -type "float3" 0 0 -2.2351742e-08 ;
	setAttr ".pt[440]" -type "float3" 0 2.7939677e-09 0 ;
	setAttr ".pt[441]" -type "float3" 0 -9.3132257e-10 -1.4901161e-08 ;
	setAttr ".pt[442]" -type "float3" 0 2.910383e-11 -2.9802322e-08 ;
	setAttr ".pt[443]" -type "float3" 0 -1.8626451e-09 1.4901161e-08 ;
	setAttr ".pt[444]" -type "float3" 0 1.8626451e-09 -7.4505806e-09 ;
	setAttr ".pt[445]" -type "float3" 0 1.8626451e-09 3.7252903e-09 ;
	setAttr ".pt[446]" -type "float3" 0 -1.8626451e-09 -3.7252903e-09 ;
	setAttr ".pt[447]" -type "float3" 0 -1.4551915e-11 -9.3132257e-10 ;
	setAttr ".pt[448]" -type "float3" 0 9.3132257e-10 1.8626451e-09 ;
	setAttr ".pt[449]" -type "float3" 0 -9.3132257e-10 -3.7252903e-09 ;
	setAttr ".pt[450]" -type "float3" 0 1.8626451e-09 -2.2351742e-08 ;
createNode lightLinker -s -n "lightLinker1";
	rename -uid "0675BD45-4049-1CC0-9434-0E9D46E9702F";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "2C4E2B78-47AE-0ACD-BB20-F19731C58486";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "A7E87D04-4786-A92D-2B19-E297B7B91F01";
createNode displayLayerManager -n "layerManager";
	rename -uid "C0C2F13E-4C39-E538-5B6C-709C2D669320";
createNode displayLayer -n "defaultLayer";
	rename -uid "D78C4FC1-40B4-08DB-27EE-01920A598FFF";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "45077BE4-493A-C62F-0203-11B9F282B018";
...
createNode polyTweak -n "polyTweak25";
	...
	setAttr ".uopa" yes;
	setAttr -s 25 ".tk";
	setAttr ".tk[355]" -type "float3" -1.9022492e-08 -0.0065580579 0.022859203 ;
	setAttr ".tk[356]" -type "float3" -1.9022492e-08 -0.0080225347 0.018931687 ;
	setAttr ".tk[357]" -type "float3" -1.9022492e-08 -0.0035287994 0.025159543 ;
	setAttr ".tk[358]" -type "float3" -1.9022492e-08 0.0028827062 0.025583662 ;
	setAttr ".tk[359]" -type "float3" -1.9022492e-08 0.0062874262 0.02345999 ;
	setAttr ".tk[360]" -type "float3" -1.9022492e-08 0.008023045 0.018782437 ;
	setAttr ".tk[361]" -type "float3" -1.9022492e-08 0.008023045 -0.019066317 ;
	setAttr ".tk[362]" -type "float3" -1.9022492e-08 0.006456783 -0.023341412 ;
	setAttr ".tk[363]" -type "float3" -1.9022492e-08 0.0027401573 -0.025376789 ;
	setAttr ".tk[364]" -type "float3" 1.9022494e-08 -0.0022095626 -0.025583662 ;
	setAttr ".tk[365]" -type "float3" 1.9022494e-08 -0.0060274936 -0.023780599 ;
	setAttr ".tk[366]" -type "float3" 1.9022494e-08 -0.008023045 -0.019690637 ;
createNode polyTweak -n "polyTweak26";
	rename -uid "5A29A4B0-40FA-EBBF-AC4F-E8AE3A895C51";
	setAttr ".uopa" yes;
	setAttr -s 5 ".tk";
	setAttr ".tk[367]" -type "float3" 4.4286818e-08 -0.16017555 0.34172693 ;
	setAttr ".tk[368]" -type "float3" -4.4286807e-08 0.16021149 0.34413287 ;
	setAttr ".tk[369]" -type "float3" -4.4286807e-08 0.16021149 -0.34413287 ;
	setAttr ".tk[370]" -type "float3" 4.4286818e-08 -0.16021152 -0.34087574 ;
...
createNode polyTweak -n "polyTweak28";
	...
	setAttr ".uopa" yes;
	setAttr -s 13 ".tk";
	setAttr ".tk[391]" -type "float3" 8.0189906e-08 -0.056389175 0.11066116 ;
	setAttr ".tk[392]" -type "float3" -8.0189906e-08 0.0019236396 0.12376495 ;
	setAttr ".tk[393]" -type "float3" -8.0189906e-08 0.055456396 0.10816284 ;
	setAttr ".tk[394]" -type "float3" -8.0189906e-08 0.06989602 0.079835266 ;
	setAttr ".tk[395]" -type "float3" -8.0189906e-08 0.069896087 -0.12374196 ;
	setAttr ".tk[396]" -type "float3" -8.0189906e-08 -0.069896057 -0.12376478 ;
	setAttr ".tk[397]" -type "float3" -8.0189906e-08 -0.069889694 0.071924314 ;
	setAttr ".tk[398]" -type "float3" 0 -3.7252903e-09 -2.9802322e-08 ;
	setAttr ".tk[399]" -type "float3" 7.1054274e-15 -2.3283064e-10 8.9406967e-08 ;
	setAttr ".tk[400]" -type "float3" 7.1054274e-15 3.7252903e-09 -8.9406967e-08 ;
	setAttr ".tk[401]" -type "float3" 7.1054274e-15 1.8626451e-08 -1.7881393e-07 ;
	setAttr ".tk[402]" -type "float3" 7.1054274e-15 0 2.9802322e-08 ;
...
createNode polyTweak -n "polyTweak30";
	...
	setAttr ".uopa" yes;
	setAttr -s 8 ".tk";
	setAttr ".tk[401]" -type "float3" -7.4979198e-08 -0.065902278 0.082247406 ;
	setAttr ".tk[402]" -type "float3" -7.4979198e-08 0.065908067 0.082263023 ;
	setAttr ".tk[403]" -type "float3" -7.4979198e-08 0.065908067 -0.04850103 ;
	setAttr ".tk[404]" -type "float3" -7.4979198e-08 0.053597067 -0.07198187 ;
	setAttr ".tk[405]" -type "float3" -7.4979198e-08 0.0017321333 -0.082263023 ;
	setAttr ".tk[406]" -type "float3" 7.4979191e-08 -0.054863017 -0.074098721 ;
	setAttr ".tk[407]" -type "float3" 7.4979191e-08 -0.065908067 -0.048962642 ;
...
connectAttr "polyExtrudeFace24.out" "pDisc4Shape.i";
